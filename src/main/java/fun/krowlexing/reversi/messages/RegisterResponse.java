...
public class RegisterResponse implements SocketMessage {
    ...
    public MessageType type() {
        return MessageType.server(ServerMessageType.RegisterResponse);
    }

    public static RegisterResponse read(SocketReader input) throws IOException {
